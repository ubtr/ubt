...
type CreateTransferRequest struct {
	...
	Amount    *CurrencyAmount `protobuf:"bytes,4,opt,name=amount,proto3" json:"amount,omitempty"`
}
...
func (x *CreateTransferRequest) GetNetworkId() *NetworkId {
	if x != nil {
		return x.NetworkId
	}
	return nil
...
func (x *CreateTransferRequest) GetAmount() *CurrencyAmount {
	if x != nil {
		return x.Amount
	}
	return nil
...
type TransferReceiver struct {
	...
	Amount *CurrencyAmount `protobuf:"bytes,2,opt,name=amount,proto3" json:"amount,omitempty"`
}
...
func (x *TransferReceiver) GetAmount() *CurrencyAmount {
	if x != nil {
		return x.Amount
	}
	return nil
...
type TransactionIntent struct {
	...
	EstimatedFee  *Uint256 `protobuf:"bytes,4,opt,name=estimated_fee,json=estimatedFee,proto3" json:"estimated_fee,omitempty"`      // estimated fee for the transaction TODO: drilldown by fee components and their price
...
func (x *TransactionIntent) GetEstimatedFee() *Uint256 {
	if x != nil {
...
func (x *TransactionCombineRequest) GetNetworkId() *NetworkId {
	if x != nil {
		return x.NetworkId
	}
	return nil
...
func (x *TransactionSignRequest) GetNetworkId() *NetworkId {
	if x != nil {
		return x.NetworkId
	}
	return nil
...
func (x *TransactionSendRequest) GetNetworkId() *NetworkId {
	if x != nil {
		return x.NetworkId
	}
	return nil
...
var file_services_construct_proto_rawDesc = []byte{
	...
	0x6e, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x0b, 0x50, 0x01, 0x5a, 0x07,
...
var file_services_construct_proto_goTypes = []interface{}{
	...
	(*NetworkId)(nil),                  // 9: ubt.NetworkId
	(*CurrencyAmount)(nil),             // 10: ubt.CurrencyAmount
	(*Uint256)(nil),                    // 11: ubt.uint256
}
