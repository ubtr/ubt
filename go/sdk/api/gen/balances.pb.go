...
func (x *GetBalanceRequest) GetNetworkId() *NetworkId {
	if x != nil {
		return x.NetworkId
	}
	return nil
...
func (x *BalanceResponse) GetAmount() *CurrencyAmount {
	if x != nil {
		return x.Amount
	}
	return nil
...
func (x *ListAccountBalancesRequest) GetNetworkId() *NetworkId {
	if x != nil {
		return x.NetworkId
	}
	return nil
...
type ListAccountBalancesResponse struct {
	...
	Amounts    []*CurrencyAmount `protobuf:"bytes,1,rep,name=amounts,proto3" json:"amounts,omitempty"`
...
func (x *ListAccountBalancesResponse) GetAmounts() []*CurrencyAmount {
	if x != nil {
		return x.Amounts
	}
	return nil
...
func (x *ListAccountBalancesResponse) GetCurrencies() []*Currency {
	if x != nil {
		return x.Currencies
	}
	return nil
...
func (x *ListCurrencyHoldersRequest) GetNetworkId() *NetworkId {
	if x != nil {
		return x.NetworkId
	}
	return nil
...
type ListCurrencyHoldersResponse struct {
	...
	Balances map[string]*Uint256 `protobuf:"bytes,1,rep,name=balances,proto3" json:"balances,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *ListCurrencyHoldersResponse) GetBalances() map[string]*Uint256 {
	if x != nil {
		return x.Balances
	}
	return nil
...
var file_services_balances_proto_goTypes = []interface{}{
	...
	(*NetworkId)(nil),                   // 7: ubt.NetworkId
	(*CurrencyAmount)(nil),              // 8: ubt.CurrencyAmount
	(*Currency)(nil),                    // 9: ubt.Currency
	(*Uint256)(nil),                     // 10: ubt.uint256
}
