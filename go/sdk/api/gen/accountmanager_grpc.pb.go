...
func (c *ubtAccountManagerClient) CreateAccount(ctx context.Context, in *CreateAccountRequest, opts ...grpc.CallOption) (*CreateAccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ubt.services.am.UbtAccountManager/CreateAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ubtAccountManagerClient) HasAccount(ctx context.Context, in *HasAccountRequest, opts ...grpc.CallOption) (*HasAccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ubt.services.am.UbtAccountManager/HasAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ubtAccountManagerClient) ListAccounts(ctx context.Context, in *ListAccountsRequest, opts ...grpc.CallOption) (*ListAccountsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ubt.services.am.UbtAccountManager/ListAccounts", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ubtAccountManagerClient) SignPayload(ctx context.Context, in *SignPayloadRequest, opts ...grpc.CallOption) (*SignPayloadResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ubt.services.am.UbtAccountManager/SignPayload", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _UbtAccountManager_CreateAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ubt.services.am.UbtAccountManager/CreateAccount",
	}
...
func _UbtAccountManager_HasAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ubt.services.am.UbtAccountManager/HasAccount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _UbtAccountManager_ListAccounts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ubt.services.am.UbtAccountManager/ListAccounts",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _UbtAccountManager_SignPayload_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ubt.services.am.UbtAccountManager/SignPayload",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
