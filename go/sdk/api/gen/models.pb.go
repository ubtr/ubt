...
type Network struct {
	...
	Metadata          *_struct.Struct                    `protobuf:"bytes,15,opt,name=metadata,proto3" json:"metadata,omitempty"`                                                                                             // network metadata in JSON format
}
...
func (x *Network) GetMetadata() *_struct.Struct {
	if x != nil {
		return x.Metadata
	}
	return nil
...
var file_models_proto_rawDesc = []byte{
	...
	0x53, 0x5f, 0x46, 0x49, 0x4e, 0x41, 0x4c, 0x49, 0x5a, 0x45, 0x44, 0x10, 0x03, 0x42, 0x0b, 0x50,
	0x01, 0x5a, 0x07, 0x61, 0x70, 0x69, 0x2f, 0x67, 0x65, 0x6e, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
