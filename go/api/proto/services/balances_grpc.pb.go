...
const (
	UbtBalanceService_GetBalance_FullMethodName          = "/ubt.services.UbtBalanceService/getBalance"
	UbtBalanceService_ListAccountBalances_FullMethodName = "/ubt.services.UbtBalanceService/listAccountBalances"
	UbtBalanceService_ListCurrencyHolders_FullMethodName = "/ubt.services.UbtBalanceService/listCurrencyHolders"
)
...
func (c *ubtBalanceServiceClient) GetBalance(ctx context.Context, in *GetBalanceRequest, opts ...grpc.CallOption) (*BalanceResponse, error) {
	...
	err := c.cc.Invoke(ctx, UbtBalanceService_GetBalance_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ubtBalanceServiceClient) ListAccountBalances(ctx context.Context, in *ListAccountBalancesRequest, opts ...grpc.CallOption) (*ListAccountBalancesResponse, error) {
	...
	err := c.cc.Invoke(ctx, UbtBalanceService_ListAccountBalances_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ubtBalanceServiceClient) ListCurrencyHolders(ctx context.Context, in *ListCurrencyHoldersRequest, opts ...grpc.CallOption) (*ListCurrencyHoldersResponse, error) {
	...
	err := c.cc.Invoke(ctx, UbtBalanceService_ListCurrencyHolders_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedUbtBalanceServiceServer must be embedded to have
...
func (UnimplementedUbtBalanceServiceServer) testEmbeddedByValue()                           {}
...
func RegisterUbtBalanceServiceServer(s grpc.ServiceRegistrar, srv UbtBalanceServiceServer) {
	// If the following call pancis, it indicates UnimplementedUbtBalanceServiceServer was
...
func _UbtBalanceService_GetBalance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UbtBalanceService_GetBalance_FullMethodName,
	}
...
func _UbtBalanceService_ListAccountBalances_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UbtBalanceService_ListAccountBalances_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _UbtBalanceService_ListCurrencyHolders_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UbtBalanceService_ListCurrencyHolders_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
