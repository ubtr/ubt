...
func (c *ubtAccountManagerClient) CreateAccount(ctx context.Context, in *CreateAccountRequest, opts ...grpc.CallOption) (*CreateAccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, UbtAccountManager_CreateAccount_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ubtAccountManagerClient) GetAccount(ctx context.Context, in *GetStoredAccountRequest, opts ...grpc.CallOption) (*GetStoredAccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, UbtAccountManager_GetAccount_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ubtAccountManagerClient) ListAccounts(ctx context.Context, in *ListAccountsRequest, opts ...grpc.CallOption) (*ListAccountsResponse, error) {
	...
	err := c.cc.Invoke(ctx, UbtAccountManager_ListAccounts_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ubtAccountManagerClient) SignPayload(ctx context.Context, in *SignPayloadRequest, opts ...grpc.CallOption) (*SignPayloadResponse, error) {
	...
	err := c.cc.Invoke(ctx, UbtAccountManager_SignPayload_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedUbtAccountManagerServer must be embedded to have
...
func (UnimplementedUbtAccountManagerServer) testEmbeddedByValue()                           {}
...
func RegisterUbtAccountManagerServer(s grpc.ServiceRegistrar, srv UbtAccountManagerServer) {
	// If the following call pancis, it indicates UnimplementedUbtAccountManagerServer was
